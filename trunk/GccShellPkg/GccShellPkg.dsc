...
# build tool.
#
# This is a port of https://efi-shell.tianocore.org/svn/efi-shell/trunk R34
# Support for ARM and building with GCC has been added.
#
...
[Defines]
  PLATFORM_NAME                  = GccShellPkg
  PLATFORM_GUID                  = B276C314-9C10-4BC3-A25D-00EE38C31928
  PLATFORM_VERSION               = 1.04
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/GccShellPkg
...
#
DEFINE EDK_SHELL_DIR             = GccShellPkg  # when "Shell" directory is directly under $(WORKSPACE) 
